...
class ViewAllImagesScreen extends StatefulWidget {
  List<JImages> profileDetailsImages = [];

  ViewAllImagesScreen(this.profileDetailsImages);

  @override
  State<StatefulWidget> createState() {
    return _ViewAllImagesScreen();
  }
}

class _ViewAllImagesScreen extends State<ViewAllImagesScreen> {
                        ...
                        child: PhotoViewGallery.builder(
                          builder: (BuildContext context, int index) {
                            return PhotoViewGalleryPageOptions(
                              filterQuality: FilterQuality.high,
                              imageProvider: NetworkImage(
                                  widget.profileDetailsImages[index].cListingImg!),
                              initialScale:
